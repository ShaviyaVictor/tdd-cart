...
describe('add items to the shopping cart', function() {
  ...
  describe('C', function() {
    ...
    it('should add three item C and total the price to 75', function() {
      cart.scan('C');
      cart.scan('C');
      cart.scan('C');
      expect(cart.total()).toEqual(75);
  ...
  describe('D', function() {
    ...
    it('should add two item D and total the price to 30', function() {
      cart.scan('D');
      cart.scan('D');
      expect(cart.total()).toEqual(30);
    });
    it('should add three item D and total the price to 45', function() {
      cart.scan('D');
      cart.scan('D');
      cart.scan('D');
      expect(cart.total()).toEqual(45);
    });
    it('should add four item D and total the price to 60', function() {
      cart.scan('D');
      cart.scan('D');
      cart.scan('D');
      cart.scan('D');
